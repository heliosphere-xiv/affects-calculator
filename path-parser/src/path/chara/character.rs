...
use crate::{
    GamePath, IResult, n_digit_id, path_id, simple_part_enum,
    types::{ModelInfo, SkeletonSlot, model_info, model_info_with_raw, skeleton_slot},
};
...
mod test {
    use crate::{
        ...
        test::test_path,
        types::{Gender, ModelInfo, ModelKind, Race, SkeletonSlot},
    };
